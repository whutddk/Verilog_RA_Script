...
# @Last Modified time: 2019-03-04 15:45:36
...
edgePath = '../../Klampt_Robotic_Arm_Script/accuracyDecrease/sp/4-4-4/100msx3/'
TTptah = '../Result/Sp/100msx3/4-4-4/trueTable/'
...
def checkout_Truetable(i):
	...
	for k in range(0,512):#check all edge
		for j in range(0,4096):#check all pix
